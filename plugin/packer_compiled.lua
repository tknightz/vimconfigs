...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'playground', 'neoscroll.nvim', 'gitsigns.nvim', 'trouble.nvim', 'indent-blankline.nvim', 'is.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
